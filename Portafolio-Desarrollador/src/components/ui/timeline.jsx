      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p
          className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
           partado pretende ser un pequeño espacio en el
           cual se pueden ver capturas de sus proyectos, tambien se puede ver 
           los repositorios solo da click en la imagen.
        </p>
      </div>
